...
{
	if($_REQUEST["tipoempleado"] == "" or $_REQUEST["sueldo"] == "")
  ...
  $resultado = mysqli_query($conexion,"INSERT INTO puesto (tipoempleado, sueldo) 
  VALUES ('".$_REQUEST["tipoempleado"]."',".$_REQUEST["sueldo"].")");
...
<legend  style="font-size: 20pt"><b>Registro Area</b></legend>
 ...
 <div class="item_requerid">TIPO DE EMPLEADO</div>
  <div class="form_requerid">
  	<input type="text" name="tipoempleado" pattern="[A-Za-z ]+" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="60"></div>

  <div class="item_requerid">SUELDO</div>
    <div class="form_requerid">
  <div class="form_requerid"><input type="number" name="sueldo" min="0" max="5000"></div>
